...
\end{itemize}
\subsection*{Notes / Study Summary}
Didn't manage to finish the Sweave file for the mastTrait, but almost there. Instead of using the code trunk to directly make figures in the Sweave file, I decidede to include the figures using the latex lines. And that's what I learned from the Sweave file in other repo (New updates: Lizzie replied to my questions on Sweave file and apparently in our lab, we source the R script making all the figures at the beginning of the Sweave file and then use the latex lines to insert the figures. This way, the updated figures will be included in the Sweave file everytime we run the Sweave file.
\vspace{1em}
\hrule
\vspace{1em}

\section*{Nov 13, 2025}
\addcontentsline{toc}{section}{Nov 13, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Finish the Sweave file for the mastTrait
    \item Review the comps reading
\end{itemize}
\subsection*{Notes / Study Summary}
Finished the Sweave file. Studied the reproduction cycle of Douglas-fir. 
\vspace{1em}
\hrule
\vspace{1em}

\section*{Nov 21, 2025}
\addcontentsline{toc}{section}{Nov 21, 2025}
...
\end{itemize}
\subsection*{Notes / Study Summary}
I have been studying intensly for the comps the past week, and today is the day! I took a walk to the Pacific Spirit Park and did some last-minute review. The comps went well and my comittee members were not harsh on me. I am very grateful to have these people joining my comps. People asked a lot about the life-history and climate change effects on resources allocation and SFT substitution. I really feel that I've learned a lot in the past few weeks and it made me feel more confident and comfortable with my own research.
\vspace{1em}
\hrule
\vspace{1em}

\section*{Nov 25, 2025}
\addcontentsline{toc}{section}{Nov 25, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Compile the MASTREE data with Silvics
    \item Updatet the Sweave file according to Lizzie's requirements.
\end{itemize}
\subsection*{Notes / Study Summary}
Not super productive yesterday, started a file to compile the MASTREE data with Silvics which I plan to finish today.
\vspace{1em}
\hrule
\vspace{1em}

\section*{Nov 26, 2025}
\addcontentsline{toc}{section}{Nov 26, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Compile the MASTREE data with Silvics
    \item Update the Sweave file according to Lizzie's requirements
    \item Nick's defence practice
\end{itemize}
\subsection*{Notes / Study Summary}
Finished compiling mastree and masting dataset with silvics, found 78 overlapping species. Finished update the Sweave file.
\vspace{1em}
\hrule
\vspace{1em}

\section*{Nov 27, 2025}
\addcontentsline{toc}{section}{Nov 27, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Get TINA running
    \item Started with pgls
\end{itemize}
\subsection*{Notes / Study Summary}
Adam showed me some updates on TINA, and the scanning can be faster and more efficient right now. Continued with some reading on pgls.
...
\section*{Nov 28, 2025}
\addcontentsline{toc}{section}{Nov 28, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Do some scanning with cores
    \item Started with pgls
\end{itemize}
\subsection*{Notes / Study Summary}
Resumed with the scanning. Started pgls, updated the phylogeny tree with the accepted names.
...
\section*{Dec 2, 2025}
\addcontentsline{toc}{section}{Dec 2, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Finish pgls
    \item Do some more grading
    \item Look into the seed data
\end{itemize}
\subsection*{Notes / Study Summary}
Finished the pgls with phyloglm function. Learned about the differences betwee nthe alpha and lambda. Had a very intense Bayes group meeting in the afternoon. And the pgls took longer than expected, so didn't have the time to do any grading. I'll catch up tomorrow.
...
\section*{Dec 3, 2025}
\addcontentsline{toc}{section}{Dec 3, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Survive all the meetings
    \item Do some more grading
    \item Look into the seed data
\end{itemize}
\subsection*{Notes / Study Summary}
It has been a really busy day. Had a great meeting with Lizzie talking about the models for mastTrait chapter, and felt so much better afterwards. Lizzie suggested that we could think about whether masting is more like a population strategy instead of a species strategy, or it's not adaptive at trait-level. She also suggested me to look for the cases against my prediction, see if there's a pattern there. I think I am now enjoying this chapter more than before and learned more from Lizzie how to think from different perspective.
...
\section*{Dec 4, 2025}
\addcontentsline{toc}{section}{Dec 4, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Meet with Victor to discuss model for mastGrowth
\end{itemize}
\subsection*{Notes / Study Summary}
Had a great meeting with Victor talking about the model for mastGrowth. He proposed a generative model thinking from the individual level, which makes it more intuitive. Of course, there are still some details we need to think of, but I am really excited about this new idea.
...
\section*{Dec 5, 2025}
\addcontentsline{toc}{section}{Dec 5, 2025}

\subsection*{Tasks for the Day}
\begin{itemize}
    \item Do some grading
\end{itemize}
\subsection*{Notes / Study Summary}
