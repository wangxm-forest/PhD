...
I will then model the tree annual growth and check if the seed count has a relationship with the current-year growth as well as the previous-year growth. Then we could tell whether there is a trade-off happening between the reproduction and annual growth.
\subsection{Significance}
